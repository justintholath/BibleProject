function Introductionfn() {
    var x = '<table><tr>';
    x += '<td class="c33" onclick="Navigate(3)">1. Bible</td>'
    x += '<td class="c33" onclick="Navigate(2)">2. ' + story_names(1) + '</td>'
    x += '<td class="c33" onclick="Navigate(5)">3. ' + story_names(2) + '</td>'
    x += '</tr></table>'
...
x += '<h3>1. Parallel Bible</h3><p>Choose between various non copyrighted Bible versions. On the Bible page, go to settings to choose the versions. These bibles are downloaded from https://ebible.org/ and https://bereanbible.com/bsb.txt </p>'
